package com.jdr.manage.core.util;
...
import com.jdr.manage.config.OSSConfig;
...
public class OSSUtils {
    ...
    public OSS getOSSClient() {
        ...
        String accessKeyId = ossConfig.getAssessKey();
     ...
     * @throws
     */
    public void uploadByInputStream(OSS ossClient, InputStream inputStream, String bucketName,
                                           String objectName) {
        try {
     ...
     * @return
     */
    public String getUrl(OSS ossClient,String key,String bucketName) {
